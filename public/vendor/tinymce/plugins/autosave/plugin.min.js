!(function() {
  ...
  var a = function(t) {
    ...
    c = function(t) {
      var e = parseInt(r.getItem(u(t) + 'time'), 10) || 0
      return !(
        new Date().getTime() - e > i(t.settings.autosave_retention, '20m') &&
        (f(t, !1), 1)
      )
    },
    f = function(t, e) {
    ...
    v = function(t, e) {
      var n = i(t.settings.autosave_interval, '30s')
      e.get() ||
  ...
  var y = tinymce.util.Tools.resolve('tinymce.EditorManager')
  y._beforeUnloadHandler = function() {
    var e
    return (
  ...
  t.add('autosave', function(t) {
    var e,
      ...
      o = a(!1)
    return (
      (window.onbeforeunload = y._beforeUnloadHandler),
      (n = o),
