!(function() {
  ...
  var n,
    ...
    k =
      (l = Array.prototype.indexOf) === undefined
        ? function(e, t) {
            return x(e, t)
          }
        : function(e, t) {
    ...
    A = w.mac ? '\u2318' : 'Ctrl',
    S = w.mac ? 'Ctrl + Alt' : 'Shift + Alt',
    O = {
      shortcuts: [
        { shortcut: A + ' + B', action: 'Bold' },
        { shortcut: A + ' + I', action: 'Italic' },
        { shortcut: A + ' + U', action: 'Underline' },
        { shortcut: A + ' + A', action: 'Select all' },
        { shortcut: A + ' + Y or ' + A + ' + Shift + Z', action: 'Redo' },
        { shortcut: A + ' + Z', action: 'Undo' },
        ...
        { shortcut: A + ' + S', action: 'Save (if save plugin activated)' },
        {
          shortcut: A + ' + F',
    ...
    j = function() {
      var e,
        ...
        n =
          ...
          '</a>'
      return [
        { type: 'label', html: C.translate(['You are using {0}', n]) },
        { type: 'spacer', flex: 1 },
        {
          text: 'Close',
          onclick: function() {
