!(function() {
  ...
  var i,
    ...
    b = function(e, t) {
      return (function(e, t) {
        for (
          var n = t !== undefined && null !== t ? t : v, r = 0;
    ...
    F = function(e) {
      var t, n, r, a
      H(e)
        ? ((a = (r = e).parentNode), E.insertAfter(r, a), E.remove(a))
        : ((t = e),
          (n = E.create('figure', { class: 'image' })),
          E.insertAfter(n, t),
          n.appendChild(t),
          n.appendChild(
            E.create('figcaption', { contentEditable: !0 }, 'Caption'),
          ),
    ...
    Q = function(e, t) {
      ...
      return (
        j(n, 'style', t.style),
        (k(n) || '' !== t.hspace) && G(n, t.hspace),
        (M(n) || '' !== t.vspace) && $(n, t.vspace),
        (D(n) || '' !== t.border) && X(n, t.border),
        (B(n, 'borderStyle') || '' !== t.borderStyle) && q(n, t.borderStyle),
    ...
    te = function(e, t, n) {
      ...
      Z(n, r, t, 'caption', function(e, t, n) {
        ...
        Z(n, r, t, 'hspace', ee(G, e)),
        Z(n, r, t, 'vspace', ee($, e)),
        Z(n, r, t, 'border', ee(X, e)),
        Z(n, r, t, 'borderStyle', ee(q, e))
    },
    ne = function(e, t) {
    ...
    ie = function(t, e) {
      var n = (function(e, t) {
        var n = document.createElement('img')
        if ((te(e, U(t, { caption: !1 }), n), j(n, 'alt', t.alt), t.caption)) {
          var r = E.create('figure', { class: 'image' })
          return (
            r.appendChild(n),
            r.appendChild(
              E.create('figcaption', { contentEditable: !0 }, 'Caption'),
                ...
                n.find('#vspace').value(''),
                  ...
                  (((a = R(a))['margin-top'] && a['margin-bottom']) ||
                    ...
                    (a['margin-top'] === a['margin-bottom']
                      ? n.find('#vspace').value(T(a['margin-top']))
                      : n.find('#vspace').value(''),
                    a['margin-right'] === a['margin-left']
                      ? n.find('#hspace').value(T(a['margin-right']))
                      : n.find('#hspace').value('')),
                  a['border-width']
                    ? n.find('#border').value(T(a['border-width']))
                    : n.find('#border').value(''),
                  a['border-style']
    ...
    ye = function(e, t) {
      return { title: 'General', type: 'form', items: be(e, t) }
    },
    xe = be,
    we = function() {
  ...
  function Te(i) {
    var t = function(e, r, a, t) {
      var o, n
      ;(o = new (y.getOrDie('XMLHttpRequest'))()).open('POST', i.url),
  ...
  var Ue = function(e) {
    ...
    ke = function(e) {
      e.on('preInit', function() {
        e.parser.addNodeFilter('figure', Ee(!0)),
          e.serializer.addNodeFilter('figure', Ee(!1))
      })
    },
    Me = function(e) {
      e.addButton('image', {
