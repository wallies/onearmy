!(function() {
  ...
  var e,
    ...
    ce = function(e) {
      var n,
        t = ae('ownerDocument.defaultView', e)
      return ((n = t), se('HTMLElement', n)).prototype.isPrototypeOf(e)
    },
    ...
    ve = {
      ...
      getSelectedListRoots: function(e) {
        var n,
          t,
          r,
          o = ((t = ge((n = e), n.selection.getStart())),
    ...
    Le = {
      unknown: function() {
        return be({ current: undefined, version: Se.unknown() })
      },
      nu: be,
      edge: _('Edge'),
      chrome: _('Chrome'),
    ...
    xe = {
      unknown: function() {
        return Ae({ current: undefined, version: Se.unknown() })
      },
      nu: Ae,
      windows: _(Te),
      ios: _('iOS'),
    ...
    He = function(e) {
      var n,
        ...
        d = je.browsers(),
        m = je.oses(),
        g = Ie(d, e).fold(Le.unknown, Le.nu),
        p = Be(m, e).fold(xe.unknown, xe.nu)
      return {
        browser: g,
        os: p,
        deviceType: ((t = g),
    ...
    sn = function(e) {
      return (n = e), (t = !0), We.fromDom(n.dom().cloneNode(t))
      var n, t
    },
    cn = function(e, n) {
      var t,
        ...
        o,
        i,
        u = ((t = e), (r = n), (o = We.fromTag(r)), (i = Ge(t)), Ye(o, i), o)
      rn(e, u)
      var a = Ze(e)
      return un(u, a), an(e), u
    },
    ...
    dn = function(e, n, t) {
      ...
      if (
        (e.settings.forced_root_block &&
          (t = t || e.settings.forced_root_block),
        t &&
          ((o = ln.create(t)).tagName === e.settings.forced_root_block &&
            ln.setAttribs(o, e.settings.forced_root_block_attrs),
        ...
        for (; (r = n.firstChild); ) {
          var s = r.nodeName
          i ||
            ('SPAN' === s && 'bookmark' === r.getAttribute('data-mce-type')) ||
            (i = !0),
            D(r, a)
              ? (u.appendChild(r), (o = null))
              : t
              ? (o || ((o = ln.create(t)), u.appendChild(o)), o.appendChild(r))
              : u.appendChild(r)
        }
      return (
        e.settings.forced_root_block
          ? i ||
            (fn.ie && !(10 < fn.ie)) ||
            o.appendChild(ln.create('br', { 'data-mce-bogus': '1' }))
    ...
    gn = function(e, n, t, r) {
      var o, i, u, a, s
      for (
        u = mn.select('span[data-mce-type="bookmark"]', n),
          r = r || dn(e, t),
          (o = mn.createRng()).setStartAfter(t),
          o.setEndAfter(n),
          a = (i = o.extractContents()).firstChild;
        a;
        a = a.firstChild
      )
        ...
        var a = [],
          n = function(e) {
            var n,
              ...
              o = ((n = i),
              (t = u),
              (r = { list: We.fromTag(t, n), item: We.fromTag('li', n) }),
              on(r.list, r.item),
              r)
      ...
      return (
        ie(n).each(function(e) {
          ...
          ;(n = e),
            ...
            (n.item = t),
            (s = f),
            Qe((a = e).list).toUpperCase() !== s.listType &&
              (a.list = cn(a.list, s.listType)),
    ...
    function() {
      ...
      for (var t = {}, r = 0; r < e.length; r++) {
        var o = e[r]
        for (var i in o) bn.call(o, i) && (t[i] = a(t[i], o[i]))
      }
      return t
    }),
    Tn = function(e, r) {
      ...
      Z(
        ...
        function(e, n) {
          return n.depth > e.length
            ? (function(e, n) {
                for (
                  var t = e.slice(0), r = n.depth - e.length, o = 1;
                  o < r;
                  o++
                )
                  t.push(W.none())
                return t.push(W.some(n)), t
              })(e, n)
            : Tn(e, n)
        },
        [],
  ...
  var wn = function(e) {
    ...
    Pn = function(e) {
      var n,
        t,
        r = Y(ve.getSelectedListItems(e), We.fromDom)
      return pn(
        [
          ee(r, P(An)),
          ee(((n = r), (t = re.call(n, 0)), t.reverse(), t), P(An)),
        ],
        function(e, n) {
    ...
    Mn = function(a, e, s) {
      var n,
        ...
        (r = En(!1)),
        Y(n, function(e) {
          return { entries: In(0, t, r, e), sourceList: e }
        }))
      G(o, function(e) {
        var n, t, r, o, i, u
        ;(n = e.entries),
    ...
    Kn = function(e, n, t, r) {
      ...
      for (
        o = n[t ? 'startContainer' : 'endContainer'],
          ...
          !t && L(o.nextSibling) && (o = o.nextSibling);
        o.parentNode !== r;
          ...
          (function(t, e, r) {
            ...
            return (
              v.each(s, function(e) {
                ...
                if (u.isBlock(e) || L(e))
                  return L(e) && u.remove(e), void (o = null)
                var n = e.nextSibling
    ...
    et = function(e, n) {
      ...
      'LI' === r.nodeName &&
        ...
        ((t = r.previousSibling) && 'LI' === t.nodeName
          ? (t.appendChild(n), w(e, r) && Zn.remove(r))
    ...
    ut = function(e, n, t, r) {
      ...
      if (a.isEmpty(r))
        ...
        var s = I(n)
        it(a, t, r), e.selection.setRng(B(s))
      }
    },
    at = function(e, n) {
      var t,
        ...
        u = e.selection,
        a = u.getStart(),
        s = ve.getClosestListRootElm(e, a),
    ...
    ft = function(n) {
      n.on('keydown', function(e) {
        e.keyCode === m.BACKSPACE
          ...
          : e.keyCode === m.DELETE && ct(n, !0) && e.preventDefault()
      })
    },
    lt = ct,
    dt = function(n) {
