!(function() {
  ...
  var v,
    ...
    S = function(e, t, n) {
      ...
      if (
        (k(e, n).reset(), e.selection.moveToBookmark(r), n.set(null), t.get())
      )
          ...
          if (0 < n.length) {
            ...
            r.setStartBefore(n[0]),
              ...
              (function(t, e, n, r, o, i, c, a) {
                ...
                var u = P.DOM.getPos(t.getContentAreaContainer()),
                  d = t.dom.getPos(a[0]),
                  f = t.dom.getRoot()
                'BODY' === f.nodeName
                  ? ((d.x -=
                  ...
                  (u.x += d.x),
                  (u.y += d.y),
                  v.moveTo(u.x, u.y + a[0].offsetHeight)
