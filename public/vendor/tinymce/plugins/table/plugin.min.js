!(function() {
  ...
  var t,
    ...
    de = (Node.DOCUMENT_TYPE_NODE,
    Node.DOCUMENT_FRAGMENT_NODE,
    Node.ELEMENT_NODE),
    me = Node.TEXT_NODE,
    ge = (Node.PROCESSING_INSTRUCTION_NODE,
    ...
    ve = function(e) {
      return (
        (e.nodeType !== ge && e.nodeType !== he) || 0 === e.childElementCount
      )
    },
    ...
    we = function(e, t) {
      return (function(e, t) {
        for (
          var n = t !== undefined && null !== t ? t : be, r = 0;
    ...
    Pe = {
      unknown: function() {
        return Ae({ current: undefined, version: ke.unknown() })
      },
      nu: Ae,
      edge: C('Edge'),
      chrome: C('Chrome'),
    ...
    je = {
      unknown: function() {
        return Le({ current: undefined, version: ke.unknown() })
      },
      nu: Le,
      windows: C(Ie),
      ios: C('iOS'),
    ...
    Nt = function(e, t) {
      return (
        ...
        ve(o) ? [] : E(o.querySelectorAll(n), le.fromDom)
      )
      var n, r, o
    }
  ...
  var At,
    ...
    jt = function(e, t) {
      return (
        (n = t),
        (o = (r = e) === undefined ? document : r.dom()),
        ve(o) ? R.none() : R.from(o.querySelector(n)).map(le.fromDom)
      )
      var n, r, o
    },
    Ft = function(e, t, n) {
    ...
    un = function(e, t) {
      var n,
        ...
        o = e.dom()
      ;(r = t),
        Qt((n = o)) && n.style.removeProperty(r),
        yt(e, 'style') &&
          '' === wt(e, 'style').replace(/^\s+|\s+$/g, '') &&
          xt(e, 'style')
    },
    an = function(t, n) {
    ...
    bn = function(e, t) {
      ...
      return (
        ...
        (o = e),
        (f = h),
        (s = P(ct.firstLayer(o, 'tr'), function(e) {
          return 0 === e.dom().childElementCount
        })),
        A(s, hn),
        (f.minCol() !== f.maxCol() && f.minRow() !== f.maxRow()) ||
          A(ct.firstLayer(o, 'th,td'), function(e) {
    ...
    Cn = function(e, t) {
      var n,
        ...
        o,
        i,
        u = ((n = e), (r = t), (o = le.fromTag(r)), (i = Ct(n)), bt(o, i), o),
        a = it(xn(e))
      return mn(u, a), u
    },
    Rn = ((At = gt),
    ...
    (Bt = Je.detect().browser),
    {
      get: function(e) {
        if (!At(e))
          throw new Error('Can only get ' + Pt + ' value of a ' + Pt + ' node')
        return Wt(e).getOr('')
      },
      getOption: (Wt =
        Bt.isIE() && 10 === Bt.version.major
          ? function(e) {
              try {
                return It(e)
              } catch (t) {
      ...
      set: function(e, t) {
        if (!At(e))
          throw new Error(
            'Can only set raw ' + Pt + ' value of a ' + Pt + ' node',
          )
        e.dom().nodeValue = t
      },
    }),
        ...
        (o = function(e) {
          for (var t = 0; t < e.childNodes.length; t++) {
            if (r(le.fromDom(e.childNodes[t])))
              return R.some(le.fromDom(e.childNodes[t]))
      ...
      return {
        ...
        cell: function(e) {
          ...
          return (
            ...
            (u = t.dom()),
            (a = n.dom()),
            Qt(u) && Qt(a) && (a.style.cssText = u.style.cssText),
            un(l, 'height'),
            1 !== e.colspan() && un(e.element(), 'width'),
            d(e.element(), l),
            l
          )
        },
    ...
    Ln = function(e) {
      return { row: Mn(e), cell: In, replace: Wn, gap: In }
    },
    jn = [
      'body',
      'p',
  ...
  function Fn() {
    return {
      up: C({ selector: _t, closest: Ft, predicate: Mt, all: nt }),
      down: C({ selector: Nt, predicate: Dt }),
      styles: C({ get: nn, getRaw: on, set: en, remove: un }),
      attrs: C({
        get: wt,
        set: vt,
        remove: xt,
  ...
  var zn = X('left', 'right'),
    ...
    qn = function(n, r, e) {
      return Hn(n, r, e).map(function(e) {
        var t = n.create().clone(r)
        return (
          n.insert().appendAll(t, e.after()), n.insert().after(r, t), zn(r, t)
        )
      })
    },
    Vn = function(i, e, u, a) {
    ...
    Rr = function(a, c, r) {
      ...
      return $e(a, c)
        ? R.some(Cr({ boxes: R.some([a]), start: a, finish: c }))
        : xr(a).bind(function(u) {
            return xr(c).bind(function(i) {
              if ($e(u, i))
                return R.some(Cr({ boxes: br(u, a, c), start: a, finish: c }))
              if (Qe(u, i)) {
                var e =
                  0 < (t = Ot(c, 'td,th', l(u))).length ? t[t.length - 1] : c
                return R.some(
                  Cr({ boxes: wr(u, a, u, c, i), start: a, finish: e }),
                )
              }
              if (Qe(i, u)) {
                var t,
                  n =
                    0 < (t = Ot(a, 'td,th', l(i))).length ? t[t.length - 1] : a
                return R.some(
                  Cr({ boxes: wr(i, a, u, c, i), start: a, finish: n }),
                )
              }
              return ur
                .ancestors(a, c)
                ...
                .bind(function(e) {
                  return Ft(e, 'table', r).bind(function(e) {
                    ...
                    return R.some(
                      Cr({ boxes: wr(e, a, u, c, i), start: o, finish: n }),
                    )
                  })
                })
            })
    ...
    Lr = function(n, e) {
      return Mr.cata(
        ...
        function(t, e) {
          return 0 === t.length
            ? R.none()
            : Nr(n, Ir.firstSelectedSelector(), Ir.lastSelectedSelector()).bind(
                function(e) {
                  return 1 < t.length
                    ? R.some({ bounds: C(e), cells: C(t) })
                    : R.none()
                },
              )
        },
    ...
    jr = function(e, t) {
      ...
      return 0 < n.length &&
        z(n, function(e) {
          return (
            (yt(e, 'rowspan') && 1 < parseInt(wt(e, 'rowspan'), 10)) ||
            (yt(e, 'colspan') && 1 < parseInt(wt(e, 'colspan'), 10))
          )
        })
        ? R.some(n)
        : R.none()
    ...
    qr = function(f, e, s, d) {
      f.on('BeforeGetContent', function(n) {
        ...
        f.on('BeforeSetContent', function(l) {
          !0 === l.selection &&
            !0 === l.paste &&
            R.from(f.dom.getParent(f.selection.getStart(), 'th,td')).each(
              function(e) {
                var c = le.fromDom(e)
  ...
  var Gr = Vr('height', function(e) {
    ...
    eo = function(e) {
      return Qr.browser.isIE() || Qr.browser.isEdge()
        ? ((n = Zr((t = e), 'padding-top', 0)),
          (r = Zr(t, 'padding-bottom', 0)),
          (o = Zr(t, 'border-top-width', 0)),
          (i = Zr(t, 'border-bottom-width', 0)),
          (u = t.dom().getBoundingClientRect().height),
          'border-box' === nn(t, 'box-sizing') ? u : u - n - r - (o + i))
        : Zr(e, 'height', Yr(e))
      var t, n, r, o, i, u
    },
    to = /(\d+(\.\d+)?)(\w|%)*/,
    ...
    uo = function(e) {
      var t,
        n = on((t = e), 'height').getOrThunk(function() {
          return eo(t) + 'px'
        })
    ...
    fo = {
      ...
      getGenericWidth: function(e) {
        return co(e).bind(function(e) {
          if (to.test(e)) {
            var t = to.exec(e)
            return R.some({ width: C(t[1]), unit: C(t[3]) })
          }
          return R.none()
        })
      },
    ...
    po = function(e) {
      var t,
        ...
        o = r.body,
        i = ((t = le.fromDom(r)),
        (n = t.dom()) === n.window && t instanceof Window
          ? t
          : ht(t)
    ...
    vo = function(e) {
      ...
      return u === o
        ? go(u.offsetLeft, u.offsetTop)
        : ((t = e),
          (n = a || le.fromDom(document.documentElement)),
          Mt(t, b($e, n)).isSome()
            ? ((r = o.getBoundingClientRect()), go(r.left, r.top))
            : go(0, 0))
    },
    bo = X('row', 'y'),
    wo = X('col', 'x'),
    ...
    Oo = { delta: o, edge: xo, positions: b(To, Co, Ro) },
    ko = {
      height: Do,
      rtl: {
        delta: function(e, t) {
  ...
  var Ao,
    ...
    Mo = function(e) {
      return Bo(Wo, e, { validate: T, label: 'function' })
    },
    _o = function(e) {
    ...
    jo = function(r, e) {
      ...
      var n = Io(R.none()),
        ...
        u = function(e) {
          var t = i(e)
          return (
            n.get().isNone() && n.set(R.some(t)),
            (a = R.some({ item: e, replacement: t })),
            t
          )
        },
        a = R.none()
                  ...
                  return (
                    ...
                    A(e.cells(), function(e) {
                      e.isNew() && u.push(e.element()),
                        fi(e.element(), 'colspan', e.colspan(), 1),
                        fi(e.element(), 'rowspan', e.rowspan(), 1),
                        fn(t, e.element())
                    }),
                    t
                  )
    ...
    di = function(e) {
      return E(e, function(e) {
        ...
        return (
          A(e.cells(), function(e) {
            var t = xn(e.element())
            fi(t, 'colspan', e.colspan(), 1),
              fi(t, 'rowspan', e.rowspan(), 1),
              fn(n, t)
          }),
          n
        )
    ...
    wi = function(e, t, n, r, o) {
      ...
      return (
        ...
        bt(i, { 'data-column': e, role: 'presentation' }),
        i
      )
    },
    yi = function(e, t, n, r, o) {
      ...
      return (
        ...
        bt(i, { 'data-row': e, role: 'presentation' }),
        i
      )
    },
    xi = function(e) {
    ...
    ki = function(e) {
      0 === (Si(e) ? e.dom().classList : Ri(e, 'class')).length &&
        xt(e, 'class')
    },
    Ni = function(e, t) {
    ...
    Vi = function(t, n) {
      return Gt.cell(n.element()).bind(function(e) {
        return Fi(t, e).map(function(e) {
          return ei(e, { generators: n.generators, clipboard: n.clipboard })
        })
      })
    },
    Gi = function(t, e) {
    ...
    tu = function(e, t, n) {
      if (e.row() >= t.length || e.column() > ii.cellLength(t[0]))
        return $i.error(
      ...
      var r = t.slice(e.row()),
        ...
        i = ii.cellLength(n[0]),
        u = n.length
      return $i.value({ rowDelta: C(r.length - u), colDelta: C(o.length - i) })
    },
    nu = function(e, t) {
    ...
    ou = function(e, t, n, r) {
      ...
      for (var o = t.startRow(); o <= t.finishRow(); o++)
        for (var i = t.startCol(); i <= t.finishCol(); i++)
          ii.mutateCell(e[o], i, ae.elementnew(r(), !1))
      return e
    },
    iu = function(e, t, n, r) {
      for (var o = !0, i = 0; i < e.length; i++)
        for (var u = 0; u < ii.cellLength(e[0]); u++) {
          ...
          !0 === a && !1 === o
            ? ii.mutateCell(e[i], u, ae.elementnew(r(), !0))
            : !0 === a && (o = !1)
        }
      return e
    },
          ...
          for (
            ...
            for (var h = s; h < m; h++) {
              ;(i = t),
                ...
                (a = h),
                (c = void 0),
                (c = b(o, ii.getCell(i[u], a).element())),
                (l = i[u]),
                1 < i.length &&
                  1 < ii.cellLength(l) &&
                  ((0 < a && c(ii.getCellElement(l, a - 1))) ||
                    (a < l.length - 1 && c(ii.getCellElement(l, a + 1))) ||
                    (0 < u && c(ii.getCellElement(i[u - 1], a))) ||
                    (u < i.length - 1 && c(ii.getCellElement(i[u + 1], a)))) &&
                  iu(t, ii.getCellElement(t[g], h), o, r.cell)
    ...
    lu = function(n, r, e, o, i) {
      var t = n.slice(0, r),
        ...
        a = ii.mapCells(n[e], function(e, t) {
          return 0 < r &&
            r < n.length &&
            o(ii.getCellElement(n[r - 1], t), ii.getCellElement(n[r], t))
            ? ii.getCell(n[r], t)
    ...
    fu = function(e, n, r, o, i) {
      return E(e, function(e) {
        var t =
          0 < n &&
          n < ii.cellLength(e) &&
          o(ii.getCellElement(e, n - 1), ii.getCellElement(e, n))
            ? ii.getCell(e, n)
            : ae.elementnew(i(ii.getCellElement(e, r), o), !0)
    ...
    su = function(e, r, o, i, u) {
      ...
      return E(e, function(e, t) {
        var n =
          t === r
            ? ae.elementnew(u(ii.getCellElement(e, o), i), !0)
            : ii.getCell(e, o)
    ...
    pu = function(e, t, n, r) {
      return (
        ii.getCellElement(e[t], n) !== undefined &&
        0 < t &&
        r(ii.getCellElement(e[t - 1], n), ii.getCellElement(e[t], n))
      )
    },
    vu = function(e, t, n) {
    ...
    Pu = function(e, t, n, r, o) {
      ...
      return E(i, function(e, t) {
        return e.filter(m(ku.hasColspan)).fold(
          function() {
            var e = hi(u, t)
            return r(e)
          },
    ...
    Bu = function(e, t, n, r) {
      ...
      return E(o, function(e, t) {
        return e.filter(m(ku.hasRowspan)).fold(
          function() {
            var e = hi(i, t)
            return r(e)
          },
    ...
    ra = {
      ...
      pasteCells: zi(
        function(e, n, t, r) {
          ...
          return au(l, e, c, n.generators(), t).fold(
            function() {
    ...
    ga = { 'border-collapse': 'collapse', width: '100%' },
    ha = { border: '1' },
    pa = function(e) {
    ...
    Ma = function(e, t) {
      ...
      ;(i['border-style'] = o.borderStyle),
        ...
        (i.width = o.width ? ca(o.width) : ''),
        (i.height = o.height ? ca(o.height) : ''),
        r
          .find('#style')
    ...
    ja = function(r, o, e) {
      ...
      pa(r) && La.syncAdvancedStyleFields(r, e),
            ...
            a(e, 'scope', i.scope),
              1 === o.length
                ...
                : ((t = e),
                  ...
                  (t.style.cssText += ';' + n)),
              a(e, 'class', i['class']),
              c(e, 'width', ca(i.width)),
              c(e, 'height', ca(i.height)),
              i.type &&
                e.nodeName.toLowerCase() !== i.type &&
                (e = u.rename(e, i.type)),
              1 === o.length && (Ia(r, e), Ba(r, e)),
              i.align && Aa(r, e, i.align),
              i.valign && Pa(r, e, i.valign)
          }),
            r.focus()
        })
    },
      ...
      if (
        ...
        1 < o.length
          ...
          : ((u = e),
            ...
            pa(i) && Ea.extend(c, La.extractAdvancedStyles(a, u)),
            (n = c)),
          0 < ya(t).length &&
            (r = {
              name: 'class',
    ...
    f.undoManager.transact(function() {
      Ea.each(s, function(e) {
        ...
        g(e, 'scope', h.scope),
          ...
          h.align !== d.align && (Ia(f, e), Aa(f, e, h.align))
      }),
        f.focus()
    })
  }
  var Ha = function(t) {
        ...
        (r = d[0]) &&
          (1 < d.length
            ...
            : ((c = r),
              ...
              va(a) && Ea.extend(f, La.extractAdvancedStyles(l, c)),
              (i = f)),
          0 < xa(t).length &&
            (o = {
              name: 'class',
      ...
      for (var a = [], c = 0; c < e; c++) {
        for (var l = le.fromTag('tr'), f = 0; f < t; f++) {
          ...
          f < r && vt(s, 'scope', 'row'),
            c < n && vt(s, 'scope', 'col'),
            fn(s, le.fromTag('br')),
            o.percentages && en(s, 'width', 100 / t + '%'),
            fn(l, s)
        }
        a.push(l)
      }
    ...
    Ya = function(r, e, t) {
      var n,
        o,
        i = r.getParam('table_default_styles', ga, 'object'),
        u = {
          styles: i,
          attributes: ((o = r),
          o.getParam('table_default_attributes', ha, 'object')),
      ...
      var c,
        ...
        s = ((c = a),
        (l = le.fromTag('div')),
        (f = le.fromDom(c.dom().cloneNode(!0))),
        fn(l, f),
        l.dom().innerHTML)
      return (
        r.insertContent(s),
        jt(oa(r), 'table[data-mce-id="__mce"]')
          .map(function(e) {
            var t, n
            return (
              Ra(r) && en(e, 'width', nn(e, 'width')),
              xt(e, 'data-mce-id'),
              (t = r),
              A(Nt(e, 'tr'), function(e) {
                Sa(t, e.dom()),
                  A(Nt(e, 'th,td'), function(e) {
                    Ta(t, e.dom())
                  })
              }),
              (n = r),
              jt(e, 'td,th').each(b(Ga, n)),
              e.dom()
            )
          })
          .getOr(null)
  ...
  var Ka = function(e, t, n) {
      var r,
        o,
        i = e.dom
      ba(e) && La.syncAdvancedStyleFields(e, n),
        ...
        e.undoManager.transact(function() {
          t || (t = Ya(e, o.cols || 1, o.rows || 1)),
            (function(e, t, n) {
              ...
              if (
                ((i['class'] = n['class']),
                (u.height = ca(n.height)),
                o.getAttrib(t, 'width') && !wa(e)
                  ? (i.width = (r = n.width) ? r.replace(/px$/, '') : '')
                  : (u.width = ca(n.width)),
                wa(e)
                  ? ((u['border-width'] = ca(n.border)),
                    (u['border-spacing'] = ca(n.cellspacing)),
                    Ea.extend(i, {
              ...
              n.style
                ...
                : (u = Ea.extend({}, o.parseStyle(o.getAttrib(t, 'style')), u)),
            ...
            !r &&
              o.caption &&
              (((r = i.create('caption')).innerHTML = Ua.ie
                ? '\xa0'
                : '<br data-mce-bogus="1"/>'),
              t.insertBefore(r, t.firstChild)),
            Ia(e, t),
            o.align && Aa(e, t, o.align),
            e.focus(),
            e.addVisual()
        })
    },
    Ja = function(t, e) {
      ...
      !0 === e
        ? (n = d.getParent(t.selection.getStart(), 'table')) &&
          ...
          ba(a) && Ea.extend(f, La.extractAdvancedStyles(l, c)),
          (m = f))
    ...
    Qa = function(a, t, c, l, n) {
      var r = aa(a),
        ...
        d = function(e) {
          return { width: ia(e.dom()), height: ia(e.dom()) }
        },
        o = function(t) {
          var n = f()
          s(n).each(function(i) {
            ...
            t(i, e).each(function(e) {
              ...
              ;(t = a),
                ...
                (n.width === o.width && n.height === o.height) ||
                  (Da(t, r.dom(), n.width, n.height),
                  Oa(t, r.dom(), o.width, o.height)),
    ...
    Za = function(e) {
      var t = R.from(e.dom().documentElement)
        .map(le.fromDom)
        .getOr(e)
      return { parent: C(t), view: C(e), origin: C(go(0, 0)) }
    },
    ec = function(e, t) {
      return { parent: C(t), view: C(e), origin: C(go(0, 0)) }
    }
  ...
  var nc = {
    ...
    oc = { resolve: xi('ephox-dragster').resolve },
    ic = function(m, g) {
      return function(e) {
        if (m(e)) {
          var t,
    ...
    fc = rc.mode({
      ...
      sink: function(e, t) {
        var n,
          ...
          o,
          i = ((n = t),
          (r = ei({ layerClass: oc.resolve('blocker') }, n)),
          (o = le.fromTag('div')),
          vt(o, 'role', 'presentation'),
          tn(o, {
            position: 'fixed',
            left: '0px',
            top: '0px',
  ...
  function hc() {
    var n,
      r = nc.create({ drag: tc(['xDelta', 'yDelta', 'target']) }),
      o = R.none(),
      e = {
        mutate: function(e, t) {
          n.trigger.drag(e, t)
        },
        events: (n = nc.create({ drag: tc(['xDelta', 'yDelta']) })).registry,
      }
    return (
      ...
      t = (function(o, t, i) {
        ...
        var c = function(e, t) {
            d.trigger.startAdjust(),
              n.assign(e),
              vt(e, 'data-initial-' + t, parseInt(nn(e, t), 10)),
              Oi(e, vc),
              en(e, 'opacity', '0.2'),
              r.go(o.parent())
          },
          l = lc(o.parent(), 'mousedown', function(e) {
            _i.isRowBar(e.target()) && c(e.target(), 'top'),
              _i.isColBar(e.target()) && c(e.target(), 'left')
          }),
          f = function(e) {
            return $e(e, o.view())
          },
          s = lc(o.view(), 'mouseover', function(e) {
            'table' === lt(e.target()) || pc(e.target(), 'table', f)
              ? (u =
                  'table' === lt(e.target())
                    ? R.some(e.target())
                    : _t(e.target(), 'table', f)).each(function(e) {
                  _i.refresh(o, e, i, t)
                })
  ...
  var wc = function(e, t) {
    ...
    Kc = function(t, e, n, r) {
      ...
      return ni(i, function(e) {
        return (
          o.selectNode(e.dom()),
          Gc(o.getBoundingClientRect(), n, r) ? Jc(t, e, n, r) : R.none()
        )
      })
    },
    Jc = function(e, t, n, r) {
    ...
    nl = document.caretPositionFromPoint
      ? function(n, e, t) {
      ...
      : function(o, i, t) {
          return le.fromPoint(o, i, t).bind(function(r) {
            var e = function() {
              return (
                (e = o), (n = i), (0 === it((t = r)).length ? el : Zc)(e, t, n)
              )
              var e, t, n
            }
    ...
    ll = function(e) {
      ...
      return qc(o, n).match({ ltr: t, rtl: t })
    },
    fl = function(e) {
      var t = le.fromDom(e.anchorNode),
        n = le.fromDom(e.focusNode)
      return _c(t, e.anchorOffset, n, e.focusOffset)
        ? R.some(
            Ic(
    ...
    sl = function(e, t) {
      var n,
        r,
        o = ((n = t), (r = e.document.createRange()), Lc(r, n), r)
      ul(e, o)
    },
    dl = function(e) {
      return ((t = e),
      R.from(t.getSelection())
        .filter(function(e) {
    ...
    gl = function(e, t, n) {
      return (
        ...
        (o = t),
        (i = n),
        (u = le.fromDom(r.document)),
        nl(u, o, i).map(function(e) {
          return Ic(
            le.fromDom(e.startContainer),
            e.startOffset,
            le.fromDom(e.endContainer),
      ...
      if (t.keyCode === hl.TAB) {
        ...
        if (e.collapsed) {
          ...
          Gt.cell(a, u).each(function(e) {
            t.preventDefault(),
              (t.shiftKey ? vl : pl)(n, u, e, r, o).each(function(e) {
    ...
    Dl = Sl(40),
    Ol = {
      ltr: { isBackward: Sl(37), isForward: Sl(39) },
      rtl: { isBackward: Sl(39), isForward: Sl(37) },
      isUp: Tl,
      isDown: Dl,
    ...
    Nl = function(e, t, n, r) {
      return { start: C(Ac.on(e, t)), finish: C(Ac.on(n, r)) }
    }
  function El(a) {
    return {
      ...
      getScrollY: function() {
        var e, t, n, r
        return ((e = le.fromDom(a.document)),
      ...
      scrollBy: function(e, t) {
        ...
        ;(n = e),
          (r = t),
          ((o = le.fromDom(a.document)) !== undefined
            ? o.dom()
            : document
  ...
  var Al = function(n, e, r, t, o) {
      return $e(r, t)
        ? R.none()
        : Sr(r, t, e).bind(function(e) {
            var t = e.boxes().getOr([])
            return 0 < t.length
              ? (o(n, t, e.start(), e.finish()),
                R.some(Rl.response(R.some(Nl(r, 0, r, On(r))), !0)))
              : R.none()
          })
    },
    Pl = {
    ...
    Bl = {
      ...
      moveBottomTo: function(e, t) {
        ...
        return Il({ left: e.left(), top: t - n, right: e.right(), bottom: t })
      },
      moveTopTo: function(e, t) {
        var n = e.bottom() - e.top()
        return Il({ left: e.left(), top: t, right: e.right(), bottom: t + n })
      },
      getTop: function(e) {
        return e.top()
      },
    ...
    Ll = function(e, t) {
      return mt(t)
        ? Ml(e, t).map(Wl)
        : gt(t)
        ? e.getRangedRect(t, 0, t, On(t)).map(Wl)
        : R.none()
    },
    jl = X('item', 'mode'),
    Fl = function(e, t, n, r) {
    ...
    Ul = [
      { current: Fl, next: zl, fallback: R.none() },
      { current: zl, next: Hl, fallback: R.some(Fl) },
      { current: Hl, next: Hl, fallback: R.some(zl) },
    ],
    ...
    Vl = { backtrack: Fl, sidestep: zl, advance: Hl, go: ql },
    Gl = {
      left: function() {
        return {
    ...
    Zl = {
      ...
      seekRight: Ql,
      walkers: function() {
        return { left: Gl.left, right: Gl.right }
      },
    ...
    of = {
      ...
      adjuster: function(e, t, n, r, o) {
        ...
        return Math.abs(n.top() - r.top()) < 1
          ...
          ? nf.retry(i)
          : n.bottom() === o.top()
          ? nf.retry(Bl.moveUp(o, 1))
          : rf(e, t, o)
          ? nf.retry(Bl.translate(i, 5, 0))
          : nf.none()
      },
      move: Bl.moveUp,
      gather: tf.before,
      ...
      return 0 === u
        ...
        : ((c = n),
          ...
          c
            ...
            .isSome()
            ? ((t = i), (a = u - 1), af(n, (e = r), o, e.move(t, 5), a))
    ...
    cf = function(t, n, e) {
      ...
      r.point(o) > i.getInnerHeight()
        ? R.some(r.point(o) - i.getInnerHeight())
        : r.point(o) < 0
        ? R.some(-r.point(o))
        : R.none()).fold(
        function() {
          ...
          .bind(function(u) {
            return Ft(e, 'td,th', o).map(function(i) {
              return $e(u, i)
                ? $e(n, u) && On(u) === r
                  ? c(i)
                  : ff.none('in same cell')
                : ur.sharedOne(sf, [u, i]).fold(
                    function() {
                      return (
                        (t = i),
                        (n = u),
    ...
    gf = (X('ancestor', 'descendants', 'element', 'index'),
      ...
      return 0 === c
        ...
        : Tf(r, o, i, u, a).bind(function(e) {
            ...
            return df.cata(
              ...
              function(e) {
                return $e(i, e) && 0 === u
                  ? Rf(r, i, u, Bl.moveUp, a)
                  : Cf(r, o, e, 0, a, c - 1)
              },
              function(e) {
                return $e(i, e) && u === On(e)
                  ? Rf(r, i, u, Bl.moveDown, a)
                  : Cf(r, o, e, On(e), a, c - 1)
              },
            )
          })
    ...
    Sf = function(e, t, n) {
      return xf.browser.isChrome() ||
        xf.browser.isSafari() ||
        xf.browser.isFirefox() ||
        xf.browser.isEdge()
        ? t.otherRetry(e, n)
        : xf.browser.isIE()
        ? t.ieRetry(e, n)
    ...
    Df = function(t, n, r) {
      ...
      o.getSelection().bind(function(r) {
        return wf(i, r.finish(), r.foffset(), u).fold(
          function() {
    ...
    Ef = function(e, t, n, r, o, i) {
      return Of.browser.isIE()
        ? R.none()
        : i(r, t).orThunk(function() {
            return Nf(e, t, n, r, o).map(function(e) {
              var t = e.range()
              return Rl.response(
                R.some(Nl(t.start(), t.soffset(), t.finish(), t.foffset())),
                !0,
              )
            })
          })
        ...
        var o,
          ...
          }),
          {
            ...
            mouseover: function(e) {
              c.each(function(r) {
                a.clear(i),
                  Bf(e.target(), u).each(function(n) {
                    Sr(r, n, u).each(function(e) {
                      var t = e.boxes().getOr([])
                      ;(1 < t.length || (1 === t.length && !$e(r, n))) &&
      ...
      keyboard: function(e, c, l, f) {
        ...
        return {
          keydown: function(e, t, n, r, o, i) {
            var u = e.raw().which,
              a = !0 === e.raw().shiftKey
            return Tr(c, f.selectedSelector()).fold(
              function() {
                return Ol.isDown(u) && a
                  ? b(Af, s, c, l, Wf.down, r, t, f.selectRange)
                  : Ol.isUp(u) && a
                  ? b(Af, s, c, l, Wf.up, r, t, f.selectRange)
                  : Ol.isDown(u)
                  ? b(Ef, s, l, Wf.down, r, t, If)
                  : Ol.isUp(u)
                  ? b(Ef, s, l, Wf.up, r, t, Pf)
                  : R.none
              },
              function(t) {
                var e = function(e) {
          ...
          keyup: function(t, n, r, o, i) {
            return Tr(c, f.selectedSelector()).fold(function() {
              ...
              return 0 == (!0 === t.raw().shiftKey)
                ? R.none()
                : Ol.isNavigation(e)
                ? Pl.sync(c, l, n, r, o, i, f.selectRange)
                : R.none()
            }, R.none)
          },
        }
      ...
      byAttr: function(o) {
        ...
        return {
          ...
          selectRange: function(e, t, n, r) {
            u(e),
              A(t, i),
              vt(n, o.firstSelected(), '1'),
              vt(r, o.lastSelected(), '1')
          },
          selectedSelector: o.selectedSelector,
          firstSelectedSelector: o.firstSelectedSelector,
          lastSelectedSelector: o.lastSelectedSelector,
  ...
  var Hf = Ea.each,
    ...
    qf = function(t) {
      var e,
        n =
          '' === (e = t.getParam('table_toolbar', ma)) || !1 === e
            ? []
            : v(e)
            ? e.split(/[ ,]/)
            : w(e)
  ...
  e.add('table', function(t) {
    var n,
      ...
      i = ((n = t),
      {
        get: function() {
          var e = oa(n)
          return kr(e, Ir.selectedSelector()).fold(
            function() {
              return n.selection.getStart() === undefined
                ? Mr.none()
                : Mr.single(n.selection)
            },
            function(e) {
    ...
    return (
      ...
      t.on('PreInit', function() {
        t.serializer.addTempAttr(Ir.firstSelected()),
          t.serializer.addTempAttr(Ir.lastSelected())
      }),
