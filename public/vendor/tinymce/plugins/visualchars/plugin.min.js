!(function() {
  ...
  var n,
    ...
    y = function(n) {
      return null === n || n === undefined ? p : O(n)
    },
    D = ((o = 'function'),
    function(n) {
      return (
    ...
    M = {
      ...
      fromPoint: function(n, e, t) {
        var r = n.dom()
        return y(r.elementFromPoint(e, t)).map(C)
      },
    },
    b = (Node.ATTRIBUTE_NODE,
    ...
    Node.ELEMENT_NODE,
    Node.TEXT_NODE),
    k = (Node.PROCESSING_INSTRUCTION_NODE,
    ...
    A = function(n, e) {
      ...
      return (
        _(r, function(n) {
          e(n) && (t = t.concat([n])), (t = t.concat(A(n, e)))
        }),
        t
      )
    },
    w = {
      isMatch: function(n) {
        return S(n) && k(n) !== undefined && m.regExp.test(k(n))
      },
      filterDescendants: A,
      ...
      replaceWithSpans: function(n) {
        return n.replace(m.regExpGlobal, x)
      },
    },
    P = function(t, n) {
      var r,
        o,
        e = w.filterDescendants(M.fromDom(n), w.isMatch)
      _(e, function(n) {
        var e = w.replaceWithSpans(k(n))
    ...
    R = function(e, n) {
      var t = e.dom.select(m.selector, n)
      _(t, function(n) {
        e.dom.remove(n, 1)
      })
    },
