...
!(function() {
  ...
  ;(Pt.prototype = Re.filters = Re.pseudos),
        ...
        ;(a = Je(
          ...
          (r = function(e, t, n, r, o) {
            ...
            if (((s += c), b && c !== s)) {
              ...
              ot.apply(r, f),
                o && !e && 0 < f.length && 1 < s + v.length && kt.uniqueSort(r)
            }
    ...
    (Pe = kt.select = function(e, t, n, r) {
      ...
      return (
        (c || Oe(e, l))(r, t, !Ve, n, (wt.test(e) && Ot(t.parentNode)) || t), n
      )
    }),
    (Ae.sortStable =
      $e
  ...
  var Sn,
    ...
    or = (Node.ATTRIBUTE_NODE,
    Node.CDATA_SECTION_NODE,
    Node.COMMENT_NODE,
    Node.DOCUMENT_NODE),
    ir = (Node.DOCUMENT_TYPE_NODE,
    Node.DOCUMENT_FRAGMENT_NODE,
    Node.ELEMENT_NODE),
    ar = Node.TEXT_NODE,
    ur = (Node.PROCESSING_INSTRUCTION_NODE,
  ...
  var Ls,
    ...
    (Fs = tr.detect().browser),
    {
      get: function(e) {
        if (!Ls(e))
          throw new Error('Can only get ' + Is + ' value of a ' + Is + ' node')
        return zs(e).getOr('')
      },
      getOption: (zs =
          ...
          var n,
            ...
            Iv(yc.getParents(n.dom, t.parentNode).reverse(), function(e) {
              ...
              a ||
                '_start' === e.id ||
                '_end' === e.id ||
                ((t = hv.matchNode(n, e, r, o, i)) && !1 !== t.split && (a = e))
            }),
            a)
  ...
  var Wy = function(e, t) {
      ...
      var i,
        ...
        l = z(
          ...
          G(c, function(e) {
            var t,
              n,
              r = ((t = La(e.getBoundingClientRect())),
              (n = -1),
              {
                left: t.left - n,
                top: t.top - n,
    ...
    Lx = function(e, t) {
      var n,
        r = ((n = e),
        Ki(rr.fromDom(n.getBody()), '*[data-mce-caret]').fold(j(null), function(
          e,
        ) {
          return e.dom()
        }))
  ...
  var Vx = function(e) {
    ...
    Wx = function(t, e) {
      ...
      f.inline || (t.getElement().style.visibility = t.orgVisibility),
        ...
        (t.parser = ((o = qb((u = t).settings, u.schema)).addAttributeFilter(
    ...
    Xx = function(e, t) {
      ...
      return (
        ...
        (e.iframeElement = l),
        (e.iframeHTML = ((g = um((f = e)) + '<html><head>'),
  ...
  var Rw,
    ...
    jw = {
      setCode: function(e) {
        e &&
          ((Hw = e), (this.rtl = !!this.data[e] && 'rtl' === this.data[e]._dir))
      },
      getCode: function() {
        return Hw
      },
